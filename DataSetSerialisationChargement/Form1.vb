Public Class Form1
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        If Me.SaveFileDialog1.ShowDialog() = DialogResult.OK Then
            Me._bdd.WriteXml(Me.SaveFileDialog1.FileName)
        End If
    End Sub
    ...
    Private Sub btnSaveSchema_Click(sender As Object, e As EventArgs) Handles btnSaveSchema.Click
        If Me.SaveFileDialog1.ShowDialog() = DialogResult.OK Then
            Me._bdd.WriteXmlSchema(Me.SaveFileDialog1.FileName)
        End If
    End Sub

    Private Sub btnLoad_Click(sender As Object, e As EventArgs) Handles btnLoad.Click
        If Me.OpenFileDialog1.ShowDialog() = DialogResult.OK Then
            Me._bdd.ReadXml(Me.OpenFileDialog1.FileName)

            Me._data = Me._bdd.Tables("Robot")
            Me._dataLocalization = Me._bdd.Tables("Localization")
    ...
    Private Sub btnLoadSchema_Click(sender As Object, e As EventArgs) Handles btnLoadSchema.Click
        If Me.OpenFileDialog1.ShowDialog() = DialogResult.OK Then
            Me._bdd.ReadXmlSchema(Me.OpenFileDialog1.FileName)
        End If
    End Sub
